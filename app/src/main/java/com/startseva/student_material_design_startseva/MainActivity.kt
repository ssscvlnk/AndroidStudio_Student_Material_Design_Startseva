package com.startseva.student_material_design_startseva
...
import com.startseva.student_material_design_startseva.data.Student
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            Student_Material_Design_StartsevaTheme {
                Surface(
...
@Composable
fun StudentPreview() {
    Student_Material_Design_StartsevaTheme(darkTheme = false) {
        StudentApp()
    }
}
@Preview
...
fun StudentDarkThemePreview() {
    Student_Material_Design_StartsevaTheme(darkTheme = true) {
        StudentApp()
    }
}